...
import { fetchProductsWithDetails } from "@/lib/api";
            ...
            <>
                ...
                {results.map((product) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-sm font-semibold mt-1" dir="ltr">
              ...
              {searchQuery.trim() && (
                <CommandItem
                  ...
                  className="border-t p-3 font-medium text-center justify-center"
                >
