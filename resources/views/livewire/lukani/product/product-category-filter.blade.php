                ...
                @endphp --}}
                    <li>
                        <div class="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                            <input class='w-4 h-4 text-green-600 bg-gray-100 border-gray-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500' id="{{ $productCategory['attributes']['slug'] }}" type="radio" value="{{ $productCategory['attributes']['slug'] }}" wire:model.change="selected">
