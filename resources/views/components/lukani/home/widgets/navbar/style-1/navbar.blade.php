                                                        ...
                                                        <div class="flex flex-col">
                                                            ...
                                                            <div class="flex flex-col">
                                                                <ul role="list" aria-labelledby="Clothing-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('گیاهان گلدار') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('گل رز') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('دسته گل ترحیم') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('گیاهان آپارتمانی') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('دسته گل') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('سبد گل') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('لوکس') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('دسته گل عروس') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('ماشین عروس') }}</a>
                                                                    </li>
                                                                    <li class="flex">
                                                                        <a href="#" class="hover:text-gray-800">{{ __('ویترین آنلاین') }}</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
