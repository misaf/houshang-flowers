                                                ...
                                                <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                                    <div class="col-start-2 grid grid-cols-2 gap-x-8">
                                                        <div class="group relative text-base sm:text-sm">
                                                            ...
                                                            <a href="{{ route('product-categories.show', 'best-selling') }}" class="mt-6 block font-medium text-gray-900 tracking-widest">
                                                                <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                                                                {{ __('پرفروش ترین ها') }}
                                                            </a>
                                                        ...
                                                        <div class="group relative text-base sm:text-sm">
                                                            ...
                                                            <a href="{{ route('product-categories.show', 'daily') }}" class="mt-6 block font-medium text-gray-900 tracking-widest">
                                                                <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                                                                {{ __('ویترین آنلاین') }}
                                                            </a>
                                                            {{-- <p aria-hidden="true" class="mt-1">{{ __('نمایش همه') }}</p> --}}
